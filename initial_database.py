...
c.execute("insert into recipes values(5,'西红柿炒鸡蛋','糖 西红柿 鸡蛋')")
...
c.execute("insert into user_recipes values(1,'1 2 3')")
c.execute("insert into user_recipes values(2,'2 3 4')")
c.execute("insert into user_recipes values(3,'3 4 5')")
c.execute("insert into user_recipes values(4,'4 5 6')")
c.execute("insert into user_recipes values(9988,'')")
